...
echo ""
echo ""
echo -e "\e[1;31m This is Only For Educational Purposes or To Prank.
echo -e "\e[1;31m Do not Use This To Irritate Others.
echo -e "\e[1;31m Do not Use This To Harm Others.
echo -e "\e[1;31m We Are Not Responsible For The Misuse Of The Script.
echo -e "\e[1;32m Update If Doesn't Work.
echo  " "
...
echo -e "\e[4;32m Invalid Input Detected !!!
echo "Press Enter To Return To Main Menu"
read a3
clear
fi
